<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IssueList.aspx.cs" Inherits="VantageHelpdesk.Pages.hd.IssueList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td style="width: 50%; text-align: left; vertical-align: top;">
                                        <table style="width: 100%">
                                            <tr>
                                                <th style="width: 30%; vertical-align: top; text-align: left">Issue #</th>
                                                <td style="width: 70%; vertical-align: top; text-align: left">
                                                    <asp:TextBox ID="txtSearchIssueID" runat="server" Width="100%" CssClass="form-control" TextMode="Number"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="gvIssues" Width="100%" runat="server" DataSourceID="edsIssue" AutoGenerateColumns="false" AllowSorting="true"
                    AllowPaging="true" DataKeyNames="issue_id,comment_count" OnRowDataBound="gvIssues_RowDataBound"
                    OnRowCommand="gvIssues_RowCommand" CssClass="table table-bordered table-striped table-hover" OnPageIndexChanging="gvIssues_PageIndexChanging">
                    <Columns>
                        <asp:BoundField DataField="issue_id" SortExpression="issue_id" HeaderText="Issue #">
                            <HeaderStyle Width="5%" BackColor="#f5f5f5" />
                        </asp:BoundField>
                        <asp:BoundField DataField="issue" SortExpression="issue" HeaderText="Comment">
                        ...
                        <%--            <asp:BoundField DataField="status_desc" SortExpression="status_desc" HeaderText="Status">
                <HeaderStyle Width="10%" BackColor="#f5f5f5"/>
            </asp:BoundField>--%>
                        <asp:BoundField DataField="site_desc" SortExpression="site_desc" HeaderText="Site">
                            <HeaderStyle Width="10%" BackColor="#f5f5f5" />
                        </asp:BoundField>
                        <asp:BoundField DataField="user_name" SortExpression="user_name" HeaderText="Logged By">
                            <HeaderStyle Width="10%" BackColor="#f5f5f5" />
                        </asp:BoundField>
                        <asp:BoundField DataField="current_owner" SortExpression="current_owner" HeaderText="Current Owner">
                            <HeaderStyle Width="10%" BackColor="#f5f5f5" />
                        </asp:BoundField>
                        <asp:BoundField DataField="account_manager" SortExpression="account_manager" HeaderText="Account Manager">
                            <HeaderStyle Width="10%" BackColor="#f5f5f5" />
                        </asp:BoundField>
                        <asp:BoundField DataField="timestamp" SortExpression="timestamp" HeaderText="Date/Time">
                            <HeaderStyle Width="10%" BackColor="#f5f5f5" />
                        </asp:BoundField>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <th style="width: 30%; vertical-align: top; text-align: left"><span class="text-danger">*</span> Company</th>
                                    <td style="width: 70%; vertical-align: top; text-align: left">
                                        <asp:DropDownList ID="ddlCompany" class="form-control" runat="server" DataSourceID="edsCompany" AutoPostBack="true" DataTextField="description" DataValueField="id" OnSelectedIndexChanged="ddlCompany_SelectedIndexChanged"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rfvCompany" runat="server" ControlToValidate="ddlCompany" SetFocusOnError="true" CssClass="text-danger" Display="Dynamic" ErrorMessage="Company is required"></asp:RequiredFieldValidator>
                                        <%--  <asp:TextBox ID="txtCompany" class="form-control" runat="server" Width="100%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvCompany" runat="server" ControlToValidate="txtCompany" SetFocusOnError="true" CssClass="text-danger" Display="Dynamic" ErrorMessage="Company is required"></asp:RequiredFieldValidator>          --%>         
                                    </td>
                                </tr>
                                <tr>
                                    <th style="width: 30%; vertical-align: top; text-align: left"><span class="text-danger">*</span> Team</th>
                                    <td style="width: 70%; vertical-align: top; text-align: left">
                                        <asp:DropDownList ID="ddlTeam" class="form-control" runat="server" DataSourceID="edsTeam" DataTextField="description" DataValueField="id"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rfvTeam" runat="server" ControlToValidate="ddlTeam" SetFocusOnError="true" CssClass="text-danger" Display="Dynamic" ErrorMessage="Team is required"></asp:RequiredFieldValidator>     
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="modal-body">
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <th style="width: 30%; vertical-align: top; text-align: left">Issue #</th>
                                    <td style="width: 70%; vertical-align: top; text-align: left">
                                        <asp:Label ID="lblHist_issue_id" runat="server" Text=""></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th style="width: 30%; vertical-align: top; text-align: left">Company</th>
                                    <td style="width: 70%; vertical-align: top; text-align: left">
                                        <asp:Label ID="lblHist_Company" runat="server" Text=""></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gvIssueHistory" Width="100%" runat="server" DataSourceID="edsIssueHistory" AutoGenerateColumns="false"
    ...
    <ef:EntityDataSource ID="edsIssue" runat="server" ContextTypeName="VantageHelpdesk.Data.HelpdeskModel" EntitySetName="vw_t_issue_list" OrderBy="it.timestamp desc" Where="(it.[issue] like '%' + @searchdesc + '%' or @searchdesc is null) and (it.[user_id] like '%' + @searchloggedby + '%' or @searchloggedby is null) and (it.[site_id] = @searchsite or @searchsite is null) and (it.[status_id] = @searchstatus or @searchstatus is null) and (it.[assigned_to_current_owner] like '%' + @searchcurrentowner + '%' or @searchcurrentowner is null)  and (it.[issue_id] = @searchissueid or @searchissueid is null) and (it.[team_id] in {@team_id} or @team_id is null)">
        <WhereParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchIssueID" Name="searchissueid" Type="Int32" DefaultValue="" ConvertEmptyStringToNull="true" />
            <asp:SessionParameter Name="team_id" Type="Int32" SessionField="team_id" />
        </WhereParameters>
    </ef:EntityDataSource>
    <ef:EntityDataSource ID="edsCompany" runat="server" ContextTypeName="VantageHelpdesk.Data.HelpdeskModel" EntitySetName="t_company" OrderBy="it.sort_order asc"></ef:EntityDataSource>
    <ef:EntityDataSource ID="edsTeam" runat="server" ContextTypeName="VantageHelpdesk.Data.HelpdeskModel" EntitySetName="t_team"></ef:EntityDataSource>
    ...
    <ef:EntityDataSource ID="edsIssueHistory" runat="server" ContextTypeName="VantageHelpdesk.Data.HelpdeskModel"
        EntitySetName="vw_t_issue_history_list" OrderBy="it.timestamp desc" Where="it.[issue_id]=@issueid">
        <WhereParameters>
            <asp:ControlParameter ControlID="hidIssueID" Name="issueid" Type="Int32" />
        </WhereParameters>
    </ef:EntityDataSource>
</asp:Content>
